...
def overview():
    ...
    trace4=go.Pie(labels=["India","Mexico","USA"],values=[ind_sent[0]+ind_sent[1]+ind_sent[2]+ind_sent[3],mex_sent[0]+mex_sent[1]+mex_sent[2]+mex_sent[3],us_sent[0]+us_sent[1]+us_sent[2]+us_sent[3]])
    data4=[trace4]
    ...
    return render_template('overview.html',langJSON=langJSON,country_sent_ind=country_sent_ind,country_sent_us=country_sent_us,country_sent_mex=country_sent_mex,dates=lab,val=val,country_tweet=country_tweet,poi_tweet=poi_tweet)
...
def tweetsearch():
    ...
    return render_template('basic_page.html', tweet_search=docs, tweet_news=news_docs,graphJSON=graphJSON,langJSON=langJSON,poi_tweet=poi_tweet)
